...
export const JUDGE_SOLANA_CLIENTS = Symbol("JUDGE_SOLANA_CLIENTS");
...
@Module({
  providers: [
    ...
    },
    {
      ...
      inject: [JUDGE_SOLANA_CLIENTS],
      useFactory: (clients: SolanaProgramClients) =>
        new SolanaReputationLedgerAdapter(clients.reputationLedger),
    },
    {
